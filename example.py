...
ontology = parser.parseFile("SmoothV2.owl")
...
margherita = elFactory.getConceptName('Vegan_Delight')
...
subsumers = elk.getSubsumers(margherita).toArray()
...
subsumers = hermit.getSubsumers(margherita).toArray()
for concept in subsumers:
    print(" - ",formatter.format(concept))
print("(",len(subsumers)," in total)")
print()
